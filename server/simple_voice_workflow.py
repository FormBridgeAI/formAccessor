"""
Simple Voice-Enabled Form Filling Workflow
Combines Azure Document Intelligence, OpenAI, and Deepgram Speech-to-Text
"""
...
def simple_voice_form_workflow(input_image_path: str, use_voice: bool = True):
    """
    Complete voice-enabled form filling workflow
    ...
    print("🚀 Starting Simple Voice-Enabled Form Workflow...")
...
def main():
    """Main function to run the simple voice-enabled workflow"""
    ...
    print("1. Voice interaction (speak your answers)")
    ...
    # Run the workflow
    result = simple_voice_form_workflow(input_image, use_voice)
    
    if result:
        print("\n🎉 Simple voice-enabled workflow completed successfully!")
